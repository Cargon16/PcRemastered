...
import Presentacion.Command.Ventas.AÒadirProductoVentaCommand;
 ...
 * @author nacho710
 * @uml.annotations
 *     derived_abstraction="platform:/resource/PCRemastered/Modelado%20de%20dise√±o.emx#_wP6HMFSUEemuHuD_HqBchg"
 * @generated "sourceid:platform:/resource/PCRemastered/Modelado%20de%20dise√±o.emx#_wP6HMFSUEemuHuD_HqBchg"
 */
public class FactoriaCommandsImp extends FactoriaCommands {
	...
	public Command generacionCommand(Evento evento) {
		...
		case addProductoVentaCommand: return new AÒadirProductoVentaCommand();
